...
// Dynamically import MapVisualization to avoid SSR issues with Leaflet
    ...
    <main style={{ padding: 20 }}>
      ...
      <div className="mt-4">
        ...
        {location ? (
          <>
            <p>
              Your coords are {location.latitude}, {location.longitude}
            </p>
      ...
      {/* Map Visualization */}
      <div className="mt-8">
        <h3 className="text-xl font-semibold mb-4">Geofence Visualization</h3>
